...
def compute_loss(
    ...
    sim_time_std = jnp.std(simulated_times) + eps

    true_time_normalized = (true_time - jnp.mean(true_time)) / true_time_std
    sim_time_normalized = (simulated_times - jnp.mean(simulated_times)) / sim_time_std
