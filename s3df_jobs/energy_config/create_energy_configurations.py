...
for i,n in enumerate(np.arange(200,2010,100)):
    data["basic_config"]["data_dir"] = f"/sdf/data/neutrino/cjesus/photonsim_output/water/monoenergetic/event_by_event/mu-/{n}MeV/"
