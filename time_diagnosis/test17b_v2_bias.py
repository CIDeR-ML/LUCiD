#!/usr/bin/env python3
"""
TEST 17b: Run V2 simulation with exact same tracks for direct comparison with test17.
"""
import sys, os
...
print("\n=== V2: data_sim vs pred_sim (tau=0.23) ===")
mins = []
for evt in range(5):
    pd = load_and_pad(evt)
