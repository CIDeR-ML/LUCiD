...
def test_beta_and_ncherenkov_passthrough(edep_path):
    p, ev = edep_path
    edep = read_edep_event_v3(str(p), 0)
...
def test_beta_range_bounded(edep_path):
...
def test_sum_ncherenkov_per_track(edep_path):
