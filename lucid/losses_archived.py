"""
Archived loss functions — no longer used in the active codebase.

These functions were extracted from lucid/losses.py during a dead-code cleanup.
They are preserved here for reference but have zero callers in the current code.
"""
