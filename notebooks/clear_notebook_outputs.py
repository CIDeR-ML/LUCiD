#!/usr/bin/env python3
"""
Script to clear outputs from all Jupyter notebooks in the notebooks directory and subdirectories.
...
def main():
    """Main function to process all notebooks in the notebooks directory."""
    ...
    if not notebook_files:
        print("No Jupyter notebooks found in the notebooks directory")
        return
    ...
    if modified_count > 0:
        ...
        print("2. Add to staging: git add notebooks/")
