...
- **two_start_reconstruction** ⭐ — START HERE. The canonical notebook on the new API: forward →
  PhotonSim event (exact gun truth) → seeds → `fit_track_multistart` → convergence plots. GPU-validated.
